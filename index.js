...
setInterval(async () => {
	...
	console.log(chalk.cyanBright('Successfully delete session'))
}, 180000)
...
setInterval(async () => {
	...
	"message": { "conversation": "Sukses mencadangkan cadangan.js ✅" }}
    let sesi = await fs.readFileSync('./FliXBOT.js')
    return await Fernazer.sendMessage('628999811229@s.whatsapp.net', { document: sesi, mimetype: 'application/json', fileName: 'cadangan.js' }, { quoted: q })
  }, 60 * 60 * 1000)
